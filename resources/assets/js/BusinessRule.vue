<template>
    <tr>
        <td>
            <select @change="loadOptions" class="form-control input-sm" :name="`rules[${index}][field]`"
                    v-model="rule.field">
        ...
        <td>
            ...
            <input class="form-control input-sm" :name="`rules[${index}][value]`" type="text" v-model="rule.value"
                   v-else>
        </td>
        <td>
