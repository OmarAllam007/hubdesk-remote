    ...
    <section class="table-container">
        <table class="listing-table table-bordered">
            ...
            <tr>
                ...
                <th>
                    <button class="btn btn-sm btn-primary pull-right" @click="addCriterion" type="button"><i
                            class="fa fa-plus-circle"></i></button>
                </th>
            </tr>
            </thead>
            <tbody>
            <tr is="Criterion" v-for="(criterion, index) in requirements" :index="index" :key="index"
                :criterion="criterion"></tr>
            </tbody>
        </table>
