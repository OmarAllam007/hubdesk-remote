...
@section('body')
    <section class="col-md-12 card-section">
        ...
        <div class="tiles-container">
            {{--<a class="tile" href="https://fiori.alkifah.com:5447/sap/bc/ui5_ui5/ui2/ushell/shells/abap/FioriLaunchpad.html?sap-client=900&sap-language=EN&sap-sec_session_created=X" target="_blank">--}}
                {{--<div class="tile-container" style="display: flex; flex-direction:column;align-items: center;justify-content: center;">--}}
                    ...
                    {{--<div class="tile-body" style="width: 100%;height: 100%;display: flex; flex-direction:column;">--}}
                        ...
                        {{--<p class="text-center" >--}}
                            {{--<img src="{{asset('images/f-logo.jpg')}}" >--}}
                        {{--</p>--}}
                        {{--@endif--}}
