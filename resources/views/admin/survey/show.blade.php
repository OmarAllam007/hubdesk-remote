        ...
        @if ($survey->questions->count())
            <table class="listing-table">
                ...
                @foreach($survey->questions as $question)
                    <tr>
                        <td><a href="{{route('admin.question.show', compact('survey','question'))}}">{{$question->description}}</a></td>
                        <td>

                            <form>
                                <a class="btn btn-xs btn-primary"
                                   href="{{route('admin.question.edit', compact('survey','question'))}}"><i class="fa fa-edit"></i> Edit</a>
