...
@section('body')
    <div class="flex w-full">
        ...
        <section class="w-3/4">
            @if ($categories->total())
                <table class="listing-table">
                    ...
                    @foreach($categories as $category)
                        <tr>
                            <td class="col-md-3"><a
                                        href="{{route('admin.category.show', $category)}}">{{$category->name}}</a></td>
                            ...
                            <td class="col-md-3">
                                <form action="{{route('admin.category.destroy', $category)}}" method="post">
                                    ...
                                    <a class="btn btn-sm btn-primary"
                                       href="{{route('admin.category.edit', $category)}}"><i class="fa fa-edit"></i>
                                        Edit</a>
            ...
            @else
                <div class="alert alert-info"><i class="fa fa-exclamation-circle"></i> <strong>No categories
                        found</strong></div>
            @endif
        </section>
@stop
