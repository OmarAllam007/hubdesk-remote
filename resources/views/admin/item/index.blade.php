...
@section('body')
    <div class="flex w-full">
        ...
        <section class="w-3/4">    @if ($items->total())
                        ...
                        <tr>
                            ...
                            <td class="col-md-3">
                                <form action="{{route('admin.item.destroy', $item)}}" method="post">
                                    ...
                                    <a class="btn btn-sm btn-primary" href="{{route('admin.item.edit', $item)}}"><i
            ...
            @else
                <div class="alert alert-info"><i class="fa fa-exclamation-circle"></i> <strong>No items found</strong>
                </div>
            @endif
        </section>
@stop
