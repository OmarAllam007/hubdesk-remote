            ...
            <div class="flex  pt-5 px-10 " dir="rtl">
                <div class="w-1/2">
                    <p class="text-2xl  " dir="rtl">
                        ...
                        <span>{{$user['allowances']['basic_salary']}} ريال</span>
                    </p>
                </div>
...
{{--                            {{$user['discounts']}}--}}
            ...
            <div class="flex  pt-5 px-10 " dir="rtl">
                <div class="w-1/2">
                    <p class="text-2xl  " dir="rtl">
                        <span>بدلات:</span>
                        <span>  بدل السكن: {{$user['allowances']['housing_allowance']}} ريال</span>
                    </p>
                </div>
                ...
                @if(isset($user['allowances']['transportation_allowance']))
                    <div class="w-1/2">
                        <p class="text-2xl  " dir="rtl">
                            <span>بدل نقل:</span>
                            <span>{{$user['allowances']['transportation_allowance']}} ريال</span>
                        </p>
                    </div>
                @endif
                    ...
                    @if(isset($user['allowances']['nature_of_work_allowance']))
                        <div class="w-1/2">
                            <p class="text-2xl  " dir="rtl">
                                ...
                                <span>  {{$user['allowances']['nature_of_work_allowance']}} ريال</span>
                            </p>
                        </div>
                    @endif
            ...
            <div class="flex flex-col pt-5  px-10 ">
                <p dir="rtl" class="text-2xl  leading-9 " style="line-height: 3rem">
                    ...
                    {{$user['iban']}} والموجود في فرعكم الرئيسي ( بنك ساب البريطاني ) وبناء عليه نتعهد تعهداً غير
                    مشروطاً وغير قابل
            ...
            <div class="flex flex-col  pt-5 px-10 " dir="rtl">
                ...
                <p class="flex text-2xl">
                    <span class="w-1/2"> رقم الفاكس: 0138459501</span>
                    <span class="w-1/2">رقم هاتف العمل: 0138459502</span>
                </p>
            </div>
            ...
            <div class="flex flex-col pt-5  px-10 ">
                <p dir="rtl" class="text-2xl  leading-9 " style="line-height: 3rem">
                    أفوض أنا / {{$user['ar_name']}} ، هوية رقم : {{$user['iqama_number']}} ، البنك السعودي البريطاني
                    تفويضاً غير
