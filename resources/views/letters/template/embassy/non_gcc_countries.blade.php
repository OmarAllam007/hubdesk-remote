    ...
    <div class="">
        <page size="A4" class="">
            ...
            <div class="flex flex-col pt-10 px-10 ">
                <p class="text-3xl">
                    <span>
                        This is to certify that Mr. {{$user['en_name']}} {{$user['en_nationality']}}, and confirming he is right residence in KSA and have a valid Iqama with ID Number {{$user['iqama_number']}} Passport Number {{$user['passport_number']}}. Is an
