...
{{--                        @dd($user)--}}
                    ...
                    بنــاءً علــى طلبـه دون أدنى مسؤوليـة على الشــركة @if($letterTicket->show_late_reason) وتم اصدار هذا الخطاب بناء على طلبكم  والافادة بخصوص سبب التأخير في نزول الرواتب  والسبب خلل في نظام تحويل الرواتب  البنكي @endif.
                    </span>
                </p>
            </div>
