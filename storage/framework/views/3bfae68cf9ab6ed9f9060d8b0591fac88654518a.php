    ...
    <div class="display-flex ticket-meta">
        ...
        <div class="card">
            <ul class="list-unstyled">
                ...
                <li>
                    <small><strong><?php echo e(t('Created at')); ?>:</strong> <?php echo e($ticket->created_at->format('d/m/Y H:i')); ?></small>
                </li>
                <?php if($ticket->due_date): ?>
                    <li>
                        <small><strong><?php echo e(t('Due Date')); ?> :</strong> <?php echo e($ticket->due_date->format('d/m/Y H:i')); ?></small>
                    </li>
                <?php endif; ?>

                <?php if($ticket->resolve_date): ?>
                    <li>
                        <small><strong><?php echo e(t('Resolve Date')); ?>:</strong> <?php echo e($ticket->resolve_date->format('d/m/Y H:i')); ?>
                ...
                <?php if($ticket->last_updated_approval): ?>
                    <li>
                        <small>
                            ...
                            <i class="fa fa-lg fa-<?php echo e($ticket->last_updated_approval->approval_icon); ?> text-<?php echo e($ticket->last_updated_approval->approval_color); ?>" aria-hidden="true"></i> <?php echo e(\App\TicketApproval::$statuses[$ticket->last_updated_approval->status]); ?>
