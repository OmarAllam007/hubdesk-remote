    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo e(t('Create Task')); ?></h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div :class="{'form-group': true , 'has-error':errors.subject}">
                            <?php echo e(Form::label('subject', t('Subject'), ['class' => 'control-label'])); ?>

                            <?php echo e(Form::text('subject', null, ['class' => 'form-control','v-model'=>'subject'])); ?>

                            <span class="help-block" v-for="error in errors.subject">{{error}}</span>
                        </div>

                        <div :class="{'form-group': true , 'has-error':errors.description}">
                            <?php echo e(Form::label('description', t('Description'), ['class' => 'control-label'])); ?>

                            <?php echo e(Form::textarea('description', null, ['class' => 'form-control richeditor','v-model'=>'description'])); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div :class="{'form-group': true , 'has-error':errors.group}">
                            <?php echo e(Form::label('group', t('Group'), ['class' => 'control-label'])); ?>

                            <?php echo e(Form::select('group_id', App\Group::selection('Select Group'),null, ['class' => 'form-control',  'v-model' => 'group','v-on:change'=>'loadTechnicians'])); ?>
                        ...
                        <div :class="{'form-group': true , 'has-error':errors.category}">
                            ...
                            <?php echo e(Form::select('category_id', App\Category::where('type')->selection('Select Category'),null, ['class' => 'form-control',  'v-model' => 'category','v-on:change'=>'loadSubcategory'])); ?>
                        ...
                        <div :class="{'form-group': true , 'has-error':errors.status}" v-show="edit">
                            <?php echo e(Form::label('status_id', t('Status'), ['class' => 'control-label'])); ?>

                            <?php echo e(Form::select('status_id', App\Status::selection('Select Status'),null, ['class' => 'form-control',  'v-model' => 'status'])); ?>
