...
tinymce.init({
    selector: '.simpleditor',
    plugins: [
        'advlist autolink lists link image imagetools charmap print preview anchor',
        'insertdatetime media table paste directionality'
    ],
    toolbar: 'undo redo | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | fontselect fontsizeselect | rtl', // image
    menubar: false,
    toolbar_items_size: 'small',
    elementpath: false,
    resize: false,
