 ...
 * Generated for Laravel 5.4.36 on 2019-08-26.
 *
...
namespace RealRashid\SweetAlert\Facades { 
    ...
    class Alert {
        ...
        {
            \RealRashid\SweetAlert\Toaster::flash($message, $type, $options);
        }
        ...
        {
            return \RealRashid\SweetAlert\Toaster::get($array);
        }
        ...
        {
            return \RealRashid\SweetAlert\Toaster::ready();
        }
        ...
        {
            return \RealRashid\SweetAlert\Toaster::message();
        }
        ...
        {
            return \RealRashid\SweetAlert\Toaster::type();
        }
        ...
        {
            return \RealRashid\SweetAlert\Toaster::options($array);
        }
        ...
        {
            return \RealRashid\SweetAlert\Toaster::option($key, $default);
        }
